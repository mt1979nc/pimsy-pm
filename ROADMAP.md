...
| **Template area (v1.13)** | **Shipped** (v1.13.0–1.13.1) | PATH tasks mirror Dock Implementation: **Click here** task action buttons (wizard / download / file-request), download→complete→upload, descriptions + attachments; hang-free Azure resync backfills existing WIP. Runbook: `v1.13-TEMPLATES.md`. |
