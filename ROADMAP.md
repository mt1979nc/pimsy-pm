...
| **Template area (v1.13)** | **Shipped** (this branch) | PATH tasks mirror Dock Implementation: clickable discovery-resource buttons, download→complete→upload on customer upload requests, descriptions + attachments; hang-free Azure resync backfills existing WIP. Runbook: `v1.13-TEMPLATES.md`. |
