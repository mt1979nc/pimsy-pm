...
| **Assign (Wave B)** | **This branch (hold from live)** | Multi-assignee join + auto-assign specialist / billing / customer lead / customer billing. Customers reassign among their team. Migration `0017_task_assignees`. |
...
| Multi-assignee / coverage | **Shipped** (v1.14.2) — join table, additive auto-assign, customer reassignment |
