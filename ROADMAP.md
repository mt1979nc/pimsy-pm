...
| **Template area (v1.13)** | **Shipped** (this branch) | PATH tasks mirror Dock Implementation: descriptions (training areas-to-cover) + attachments; hang-free Azure resync backfills existing WIP; new workspaces inherit both. Editor/duplicate/areas remain. Runbook: `v1.13-TEMPLATES.md`. |
