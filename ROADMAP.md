...
| **Dock parity (v1.12)** | **Shipped** (v1.12.0–1.12.2) | Active-book prune, nested playbook resync, **task attachments** (Discovery Wizard LINK + billing sheets) that clone onto matching PATH tasks and backfill via resync, training checklists, customer Learning Center. RAC→TANC rename (do not delete). Runbook: `v1.12-DOCK-PARITY.md`. |
