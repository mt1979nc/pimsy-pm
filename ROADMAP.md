...
| **Template area (v1.13)** | **Shipped** (v1.13.0–1.13.9) | Dock task buttons, file library Link/Form, expose/hide tabs, **analytics-exclude** for E2E customers/projects (`excludeFromAnalytics`). Runbook: `v1.13-TEMPLATES.md`. |
