...
| **Playbook / staffing (v1.9)** | **Shipping** (this branch → v1.9.0) | Editable templates, four site paths, optional areas, per-project N/A, staffing roles + auto-assign + manager overview, staff-only Update History. Not Prism forecast. |
...
| 2. Playbook + staffing | **v1.9.0** | **Shipping** (this branch) | Editable templates, four paths, optional areas, N/A, staffing roles, staff Update History. |
