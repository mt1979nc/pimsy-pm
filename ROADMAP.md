...
| **Learning Center PIMSY how-tos (v1.17)** | **Shipped** | Customer LC is Dock Implementation Template Learning Center content for **using PIMSY** (Getting started, Password & access, Scheduling, Notes, Providers, Training 1–5, Reference). Not a PATH project journey. Named Storylane cards; no invented URLs. No migrate; `npm run db:seed -- --templates-only`. |
...
| File library by area | **Shipped** (v1.12, LC v1.17) | Reusable library + Learning Center **PIMSY how-to** groups; named Storylanes; placeholders until Dock binaries / URLs are uploaded. |
