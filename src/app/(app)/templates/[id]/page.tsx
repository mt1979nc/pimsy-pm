...
export default async function TemplateEditorPage({
  ...
  return (
    <>
      <PageHeader
        title={row.name}
        subtitle="Dock-style editor: descriptions, nested tasks, default assignee by role (not a person), connected keys, move to another tab, training checklists, default files, and optional areas. Live projects are not rewritten."
        breadcrumb={
